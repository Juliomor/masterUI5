...
sap.ui.define([
     ...
     * @param {typeof sap.m.RaitingIndicator} RaitingIndicator
     * @param {typeof sap.m.Label} ContLabelrol
     * @param {typeof sap.m.Button} Button
     */
    function (Control, RaitingIndicator, Label, Button) {
        "use strict";

        return Control.extend("alight.sapui5.control.ProductRating", {

            metadata: {
                properties: {
                    value: { type: "float", dafaulValue: 0 }
                },
                aggregations: {
            ...
            init: function () {
                ...
                this.setAggregation("_rating", new RaitingIndicator({
                    value: this.getValue(),
                    iconSize: "2rem",
                    visualMode: "Half",
